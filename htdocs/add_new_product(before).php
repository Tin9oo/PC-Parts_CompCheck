    ...
    <body>
        ...
        <?php
            ...
            for ($i=0;$i<9;$i++) {
                ...
                echo "<form method='get' action='add_new_",$part_type_array[$i],".php'>";

                echo "제품 정보<br>";
                echo "<input type='text' name='",$part_type_array[$i],"_part_type' placeholder='type'> <br>";
                echo "<input type='text' name='",$part_type_array[$i],"_part_number' placeholder='number'> <br>";
                echo "<input type='text' name='",$part_type_array[$i],"_part_name' placeholder='name'> <br>";
                ...
                echo "<br><input type='submit' value='추가' formaction='add_new_",$part_type_array[$i],".php'/>";
